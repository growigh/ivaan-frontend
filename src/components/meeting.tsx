...
export default function Meeting() {
  return (
    <section className="container mx-auto mt-20 sm:mt-42 px-6 md:px-20">
      <div className="flex items-center tracking-[2%] justify-center">
        <div className="border-2 border-white/20 text-white/70 rounded-2xl sm:rounded-4xl inline-block p-3 md:p-6 flex-col uppercase">
      ...
      <div className="flex flex-col sm:flex-row justify-between mt-37">
        <div>
        ...
        <div className='mt-4'>
          <Image
            ...
            width={480}
            height={480}
            className="rounded-4xl max-sm:w-[278px]"
          />
        </div>
      </div>
    </section>
