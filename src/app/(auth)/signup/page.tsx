...
export default function SignupPage() {
  ...
  const handleGoogleSignup = async () => {
    setIsLoading(true)
    try {
      // Initiate Google OAuth login (same endpoint for both login and signup)
        ...
        <Card className="border-slate-800 bg-slate-800/50 backdrop-blur-xl shadow-2xl">
          <CardHeader className="pb-4">
            <div className="text-center">
              <h2 className="text-xl font-semibold text-white mb-2">Get started for free</h2>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="bg-slate-700/30 border border-slate-700 rounded-lg p-4 mt-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-xs text-slate-300 font-medium">What you get:</p>
                  <ul className="text-xs text-slate-400 mt-1 space-y-1">
                    <li>• Free account with full access</li>
